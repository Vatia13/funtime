...
<table class="formadd">
    ...
    <?if($registry['banner'][0]['cat_id'] > 0 and empty($registry['banner'][0]['position'])):?>
    <input type="hidden" name="title" id="banner_position" value="- <?=$DB->getOne("SELECT name FROM #__category WHERE #__category.id = '".$registry['banner'][0]['cat_id']."'");?>">
        <?endif;?>
    <tr>
        <td></td>
        <td align="left">
