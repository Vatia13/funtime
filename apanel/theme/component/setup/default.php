...
<?if ($user->get_property('userID')>0):?>
	<?if (count($all)>0):?>
		...
		<form method="post" action="" enctype="multipart/form-data"/>
			<?if ($num['photo']==''): $img_path="../img/nofoto.png"; 
				else: //http://rche.ru/cms/images/1/100/100/1/83341552_ava.png
				$split=explode('/',$num['photo']);
				$img_path='../images/'.$split[3].'/'.$avator_width_profile.'/'.$avator_height_profile.'/'.$avator_sc_profile.'/'.$split[4];
				endif;?>
...
<div id='tabname_2' onclick="showtab('2')" class='nonactive'><u>Дополнительно</u></div>
	...
	<div id='tabcontent_1' class='show'>
		...
		<tr><td width="250" align="center" valign="top">
			<img src="<?=$img_path?>" alt="" class="imgadm" width="<?=$avator_width_profile?>" height="<?=$avator_height_profile?>"/><br/>
