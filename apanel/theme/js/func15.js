...
function addField(akey) {
    ...
    div.innerHTML = "<textarea name=\"slide[name][]\" class=\"slide_img  tinymce_short\" id=\"slidename1\" placeholder=\"ტექსტი\" style=\"align:left;\"><input type='hidden' name='slide[img][]' id='slide" + curFieldNameId + "'/> <a href='http://funtime.ge/filemanager/dialog.php?type=1&akey=" + akey + "&field_id=slide" + curFieldNameId + "' class='btn-blue iframe-btn' type='button'>ფოტო " + curFieldNameId + "</a> <label class='slide" + curFieldNameId + "'>---</label> <a onclick=\"return deleteField(this)\" href=\"#\" class=\"razdel-bodys-aa\">[X]</a>";

    //div.innerHTML = "<input type=\"text\" name=\"slide[name][]\" value=\"\" placeholder=\"ფოტოს დასახელება\" /><input type='hidden' name='slide[img][]' id='slide" + curFieldNameId + "'/> <a href='http://funtime.ge/filemanager/dialog.php?type=1&akey=" + akey + "&field_id=slide" + curFieldNameId + "' class='btn-blue iframe-btn' type='button'>ფოტო " + curFieldNameId + "</a> <label class='slide" + curFieldNameId + "'>---</label> <a onclick=\"return deleteField(this)\" href=\"#\" class=\"razdel-bodys-aa\">[X]</a>";
...
function deletePost(id){
    ...
    if(conf == true){
        window.location.href = "/apanel/index.php?del="+id;
    }
}
    ...
    $("#imgInp").change(function(e) {
        ...
        if ((file = this.files[0])) {
            ...
            img.onload = function() {
                ...
                if((this.width > sz[0] && this.height > sz[1]) || (this.width > sz[0] && this.height == sz[1]) || (this.width == sz[0] && this.height > sz[1] )){
                    /*$(".imgplace div").css({width:sz[0] + "px",height:sz[1] + "px"});
                    $("#popupbg").show();
                    $("#imgpl").show();
                    $(".imgplace").show();
