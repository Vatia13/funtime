var RedBullBanner_800X100 = (function(canvasID,click)
{
	...
	var frame1 =
	{
        ...
        init   :function(context)
        {
			...
			frame1.bg.src     = '/img/secretary.png';
			frame1.phones.src = '/img/phones.png';
			frame1.text.src   = '/img/text1.png';
        }
	};
	...
	var frame2 =
	{
        ...
        init   :function(context)
        {
			...
			frame2.can.src    = '/img/can.png';
			frame2.text.src   = '/img/text2.png';
        }
	};
    ...
    var bg =
    {
        ...
        {
            bg.context    = context;
			bg.border.src = '/img/border.png';
			bg.corner.src = '/img/border_corner.png';
        }
    };
