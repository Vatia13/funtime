...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<script>
        ...
        var userGroup = <?php echo $user->get_property('gid');?>;
	    //dropzone config
	...
	<script type="text/javascript" src="js/include.js?ver=<?=rand(0,99999);?>"></script>
    </head>
    <body>
	...
	<input type="hidden" id="new_folder" value="" />
