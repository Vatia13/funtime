...
<div class="content">
    ...
    <div class="post-image" style="border:25px solid <?=$registry['color']['frame'];?>">
        ...
        <img src="/img/uploads/news/read/<?=$registry['post'][0]['img'];?>" width="780" height="440" alt="<?=$registry['post'][0]['alt_search']?>"/>
    </div>


    <div class="post-author">
        <div class="post-avatar" align="center">
            <div style="margin-bottom:10px;background:url('/forum/img/avatars/<?=$registry['post'][0]['user'];?>.jpg') 50% 40% no-repeat;"></div>
        </div>
    ...
    <?endif;?>
    <div class="post-short" style="min-height:250px;">
