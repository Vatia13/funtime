...
;(function($){
    $.fn.pgwSlideshow = function(options) {
            ...
            if (typeof pgwSlideshow.plugin.find('.ps-current').animate == 'function') {
                pgwSlideshow.plugin.find('.ps-current').stop().animate({
                    ...
                    if (pgwSlideshow.config.maxHeight) {
                        ...
                        pgwSlideshow.plugin.find('.ps-current > ul > li img').css('max-height', '600px');
                    }
                });
            } else {
        ...
        var setup = function() {
            ...
            pgwSlideshow.plugin.prepend('<div class="ps-current"><ul class="gallery clearfix"></ul><span class="ps-caption"></span></div>');
            ...
            pgwSlideshow.plugin.find('.ps-list > ul > li').each(function() {
                ...
                $(this).wrapInner('<a href="'+ element.thumbnail +'" class="ps-item' + (elementId == 1 ? ' ps-selected' : '') + '"    rel="prettyPhoto[gallery1]" ></a>');

                // Set element in the current list
                var currentElement = $('<li class="elt_' + elementId + '" ></li>');

                if (element.image) {
                    currentElement.html('<a href="' + element.image + '" rel="prettyPhoto[gallery1]" ><img src="' + element.image + '" alt="' + (element.title ? element.title : '') + '"></a>');
                } else if (element.thumbnail) {
                    currentElement.html('<a href="' + element.thumbnail + '" rel="prettyPhoto[gallery1]" ><img src="' + element.thumbnail + '" alt="' + ($(this).attr("title") ? $(this).attr("title") : '') + '"></a>');
                }
