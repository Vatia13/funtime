...
<link type="text/css" rel="stylesheet" href="/<?=$theme?>css/new_slider/prettyPhotoOriginal.css?ver=0.4" />
<script src="/<?=$theme?>js/new_slider/jquery.prettyPhotoOriginal.js?ver=0.6"></script>
