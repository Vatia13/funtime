...
<div class="massage-slash"></div>
	...
	<input name="delchecktresh" type="hidden" value="1"/>
	<?if(count($all_mess)):?>
		<?foreach($all_mess as $num):?>
			...
			<tr>
				...
				<td align="center" width="102">
					...
					<a href="/com/message/del/<?=$num['id']?>"><img src="/<?=$theme?>images/messagen/del.png" width="30" height="30" border="0" alt="Удалить" title="Удалить"/></a>
				</td>
			</tr>
			</table>
	        <?endforeach;?>
