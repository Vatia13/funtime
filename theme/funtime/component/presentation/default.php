	...
	<div id="results">  
        ...
        <table  width="589" style="background-color:#27bfc4; color:white;"> 
          ...
          <tr align="center">
            <td>პოზიცია</td>
            <td>ზომა</td>
            <td>ფასი <img src="/<?=$theme?>images/esc.png" align="right" onclick="out();" /></td>
          </tr>
          <tr>
        ...
        <p style="position:relative; bottom:0px; padding:5px;" ><strong>ფასები მოცემულია ეროვნულ ვალუტაში...</strong></p>
	</div>
</div>
</div>
</div> 
...
<div class="table_headers" style="margin:10px;"></div>
    <div class="logoo" style="position: relative;bottom: 80px;">
	<div class="table_headers"> ლოგო </div>
	<? if(!empty($item['logo_url'])){?><img src="<?=$item['logo_url']?>" width="50"/><? } ?></div>
<div class="table_headers" style="margin:10px;"></div>
    <div class="rubrica"> <div class="table_headers"> რუბრიკა </div> <font style="position: relative;bottom: 90px; font-weight:600; color:black;"><?=$item['rubric']?></font></div> 
    <div class="sex">
    ...
    <div class="vizuali" onclick="view('<?=$item['stat']?>','<?=$item['rubric_id']?>')" style="position: relative;bottom: 45px; height:105px;"><? if(!empty($item['view'])){?><img src="<?=$item['view']?>" width="50"/><? } ?></div> 
	</div>
	<? $counter++;?>
<?endforeach?>
<table id="tab">
